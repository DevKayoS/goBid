...
SELECT id, seller_id, product_name, description, baseprice, auction_end, is_sold, created_at, updated_at FROM products WHERE auction_end >= NOW() and is_sold = false
`

func (q *Queries) ListAvailableProducts(ctx context.Context) ([]Product, error) {
